...
// File contracts/access/TimelockController.sol
...
// File contracts/token/RarePizzas/IERC721.sol
...
// File contracts/token/RarePizzas/IERC721Enumerable.sol
...
// File contracts/token/RarePizzas/IERC721Metadata.sol
...
// File contracts/token/RarePizzas/IERC721Receiver.sol
...
// File contracts/token/RarePizzas/RarePizzas.sol
...
contract RarePizzas is Context, ERC165, IERC721, IERC721Metadata {
    ...
    string private _uri = "https://ipfs.io/ipfs/";
    ...
    function slice(uint pizzaId) public{
      require(pizzaId%8==0);
      require(RarePizzas.ownerOf(pizzaId) == msg.sender, "RAREPIZZA: Pizza does not belong to you");
      _burn(pizzaId);
      for(uint i=0;i<8;i++){
        _mint(msg.sender,pizzaId + i + 1);
      }
    }

    function combine(uint pizzaId) public {
      for(uint i=0;i<8;i++){
        require(RarePizzas.ownerOf(pizzaId + i + 1) == msg.sender, "RAREPIZZA: All 8 pizza slices do not belong to you");
        _burn(pizzaId + i + 1);
      }
      _mint(msg.sender,pizzaId);
    }
